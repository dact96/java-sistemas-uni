...
import Sistuni.egcc.CobroCineApp.service.CineService;
 ...
 * @author Diego
 */
public class DomFerView extends javax.swing.JPanel {

    /**
     * Creates new form DomFerView
     */
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        df.setCantNiñ(Integer.parseInt(txtNiñ.getText()));
        df.setCantAdult(Integer.parseInt(txtAdult.getText()));
        }
        //Proceso
        
        if(btn2d.isSelected() || btn3d.isSelected() || btn4d.isSelected()){
            if("2d".equals(df.getTipo()))
            df.setPrecio();
            else if("3d".equals(df.getTipo()))
            df.setPrecio(df.getTipo());
            else
            df.setPrecio(df.getTipo());

            precioadult=df.getPrecio();

            precioniño=control.precioNiño(precioadult,df);

            float total=control.calcularTotal(precioadult, precioniño,df);

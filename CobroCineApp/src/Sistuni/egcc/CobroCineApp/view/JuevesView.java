 ...
 * @author Diego
 */
public class JuevesView extends javax.swing.JPanel {

    /**
     * Creates new form JuevesView
     */
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        jue.setCantNiñ(Integer.parseInt(txtNiñ.getText()));
        jue.setCantAdult(Integer.parseInt(txtAdult.getText()));
        }
        //Proceso
        if(btn2d.isSelected() || btn3d.isSelected() || btn4d.isSelected()){
        
            if("2d".equals(jue.getTipo()))
            jue.setPrecio();
            else if("3d".equals(jue.getTipo()))
            jue.setPrecio(jue.getTipo());
            else
            jue.setPrecio(jue.getTipo());

            precioadult=jue.getPrecio();

            precioniño=control.precioNiño(precioadult,jue);

            float total=control.calcularTotal(precioadult, precioniño,jue);

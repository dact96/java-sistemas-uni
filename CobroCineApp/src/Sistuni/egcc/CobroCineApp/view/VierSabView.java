 ...
 * @author Diego
 */
public class VierSabView extends javax.swing.JPanel {

    /**
     * Creates new form VierSabView
     */
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        vs.setCantNiñ(Integer.parseInt(txtNiñ.getText()));
        vs.setCantAdult(Integer.parseInt(txtAdult.getText()));
        }
        //Proceso
       if(btn2d.isSelected() || btn3d.isSelected() || btn4d.isSelected()){
            if("2d".equals(vs.getTipo()))
            vs.setPrecio();
            else if("3d".equals(vs.getTipo()))
            vs.setPrecio(vs.getTipo());
            else
            vs.setPrecio(vs.getTipo());

            precioadult=vs.getPrecio();

            precioniño=control.precioNiño(precioadult,vs);

            float total=control.calcularTotal(precioadult, precioniño,vs);
